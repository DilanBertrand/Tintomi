        ...
        {status === 'sent' ? (
          ...
          <motion.div key="closed" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <button
              ...
              className="min-h-12 w-full rounded-full bg-[#e9ece8] px-5 py-3 text-sm font-semibold text-[#0f1412] transition-opacity duration-200 hover:opacity-90 sm:w-auto"
            >
