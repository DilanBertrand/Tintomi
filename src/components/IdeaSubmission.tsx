  ...
  return (
    <>
      <motion.button
        ...
        className="fixed right-4 bottom-[calc(5.5rem+env(safe-area-inset-bottom))] z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#e9ece8] text-[#0f1412] shadow-lg shadow-black/40 transition-opacity hover:opacity-90 sm:bottom-6"
